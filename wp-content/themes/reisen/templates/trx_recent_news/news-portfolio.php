...
if ( !function_exists( 'reisen_template_news_portfolio_theme_setup' ) ) {
	add_action( 'reisen_action_before_init_theme', 'reisen_template_news_portfolio_theme_setup', 1 );
	function reisen_template_news_portfolio_theme_setup() {
		reisen_add_template(array(
			'layout' => 'news-portfolio',
			'template' => 'news-portfolio',
			'mode'   => 'news',
			'title'  => esc_html__('Recent News /Style Portfolio/', 'reisen'),
...
// Template output
if ( !function_exists( 'reisen_template_news_portfolio_output' ) ) {
	function reisen_template_news_portfolio_output($post_options, $post_data) {
