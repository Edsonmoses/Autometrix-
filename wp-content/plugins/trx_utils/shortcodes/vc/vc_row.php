...
if (function_exists('vc_map_get_attributes')) {						// New VC
	 ...
	 * @var $scheme		- added by Reisen
	 * @var $inverse	- added by Reisen
	 * @var $atts
	 * @var $el_class
	 * @var $full_width
	 * @var $full_height
	...
	// Added by Reisen:
	// Color scheme
	if ($scheme && !reisen_param_is_off($scheme) && !reisen_param_is_inherit($scheme)) $css_classes[] = 'scheme_'.esc_attr($scheme);
	// Inverse colors
	if ($inverse && !reisen_param_is_off($inverse)) $css_classes[] = 'inverse_colors';
	...
	// Add Reisen color scheme in the row
	if ($scheme && !reisen_param_is_off($scheme) && !reisen_param_is_inherit($scheme)) $css_class .= ' scheme_'.esc_attr($scheme);
	...
	} ?> <?php reisen_show_layout($style); ?>><?php
	echo wpb_js_remove_wpautop( $content );
	?></div><?php reisen_show_layout($this->endBlockComment('row'));
	if ( ! empty( $full_width ) ) {
