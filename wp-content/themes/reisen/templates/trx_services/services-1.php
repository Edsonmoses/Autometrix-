...
if ( !function_exists( 'reisen_template_services_1_theme_setup' ) ) {
	add_action( 'reisen_action_before_init_theme', 'reisen_template_services_1_theme_setup', 1 );
	function reisen_template_services_1_theme_setup() {
		reisen_add_template(array(
			'layout' => 'services-1',
			'template' => 'services-1',
			'mode'   => 'services',
			'title'  => esc_html__('Services /Style 1/', 'reisen'),
			'thumb_title'  => esc_html__('Medium images (crop)', 'reisen'),
			'w'		 => 370,
			'h'		 => 255
		));
	}
...
// Template output
if ( !function_exists( 'reisen_template_services_1_output' ) ) {
	function reisen_template_services_1_output($post_options, $post_data) {
