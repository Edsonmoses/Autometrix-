...
$sidebar_show   = reisen_get_custom_option('show_sidebar_main');
$sidebar_scheme = reisen_get_custom_option('sidebar_main_scheme');
...
if (!reisen_param_is_off($sidebar_show) && is_active_sidebar($sidebar_name)) {
	...
	<div class="sidebar widget_area scheme_<?php echo esc_attr($sidebar_scheme); ?>" role="complementary">
		<div class="sidebar_inner widget_area_inner">
			...
			reisen_storage_set('current_sidebar', 'main');
